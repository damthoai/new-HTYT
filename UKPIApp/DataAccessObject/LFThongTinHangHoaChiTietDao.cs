...
{
    public class LFThongTinHangHoaChiTietDao : clsBaseDAO
    {
        ...
        private const string p_LF_searchThongTinHangHoaChiTiet = "p_LF_searchThongTinHangHoaChiTiet";
        ...
        */
        ...
        //Phong làm
        public List<LFThongTinHangHoaChiTiet> SearchThongTinHangHoaChiTiet(string maHang2)
        {
            try
            {
                SqlParameter[] Params = new SqlParameter[1];
                Params[0] = new SqlParameter("@MaHang", maHang2);
               // MessageBox.Show(maHang2.ToString());
                var dtResult = DataServices.ExecuteDataTable(CommandType.StoredProcedure, p_LF_searchThongTinHangHoaChiTiet, Params);
                
                return this.ConvertDataTableToList<LFThongTinHangHoaChiTiet>(dtResult);
